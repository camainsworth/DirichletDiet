graphics.off()     #closes open graphics
rm(list=ls())      #clears variables in memory
...
whatplot = 4  #What graphs do you want to produce? Chose 1-4
...
options(digits=20)  
nfishavg    <- 50    #number of stomachs to average
nbootstraps <- 1000
...
setwd("C:/Users/ainsworth/Documents/GitHub/DirichletDiet") #this should be your local github repository
x=read.csv(paste(getwd(),"/","Final_CSV_For_Dirichlet.csv",sep=""))
...
#write column names
columnnames<-c("PredatorName","PreyName","lower95","upper95", "mle", "simpleaverages", "bootaverage", "bootmode")
#write to file here
